...
def select_new_GPU(candidate_gpus, sm_req, sm_lim, memory, omega, gamma, alpha, beta):
...
if __name__ == '__main__':
    ...
    plt.xticks()
    plt.tight_layout()
    plt.savefig('k8s-timeline.png', dpi=300)
